...
DATE_STRING_FORMAT = "%d-%02d-%02d"
WEEK_STRING_FORMAT = "%dw%d"
MONTH_STRING_FORMAT = "%d-%02d"
QUARTER_STRING_FORMAT = "%dq%d"
...
SCRAPY_METHOD_OPTION_OPEN_INTEREST_NAME = "option open interest"
SCRAPY_METHOD_OPTION_OPEN_INTEREST_CFG = {
    "description": u'選擇權未平倉',
    "module_name": "histock_scrapy",
    "class_name": "HiStockScrapy",
    "data_time_unit": DATA_TIME_UNIT_DAY,
    "can_set_time_range": False,
}
SCRAPY_METHOD_OPTION_OPEN_INTEREST_CFG.update(SCRAPY_METHOD_TYPE_REQUESTS_MARKET)
SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_OPTION_OPEN_INTEREST_NAME] = SCRAPY_METHOD_OPTION_OPEN_INTEREST_CFG

SCRAPY_METHOD_WEEKLY_OPTION_OPEN_INTEREST_NAME = "weekly option open interest"
SCRAPY_METHOD_WEEKLY_OPTION_OPEN_INTEREST_CFG = {
    "description": u'周選擇權未平倉',
    "module_name": "histock_scrapy",
    "class_name": "HiStockScrapy",
    "data_time_unit": DATA_TIME_UNIT_DAY,
    "can_set_time_range": False,
}
SCRAPY_METHOD_WEEKLY_OPTION_OPEN_INTEREST_CFG.update(SCRAPY_METHOD_TYPE_REQUESTS_MARKET)
SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_WEEKLY_OPTION_OPEN_INTEREST_NAME] = SCRAPY_METHOD_WEEKLY_OPTION_OPEN_INTEREST_CFG
# Market End
...
SCRAPY_METHOD_QUARTERLY_CASHFLOW_STATEMENT_NAME = "quarterly cashflow statement"
SCRAPY_METHOD_QUARTERLY_CASHFLOW_STATEMENT_CFG = {# 現金流量表(季)
    "description": u'現金流量表(季)',
    "module_name": "cmoney_scrapy",
    "class_name": "CMoneyScrapy",
    "data_time_unit": DATA_TIME_UNIT_QUARTER,
    "can_set_time_range": False,
}
SCRAPY_METHOD_QUARTERLY_CASHFLOW_STATEMENT_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_QUARTERLY_CASHFLOW_STATEMENT_NAME] = SCRAPY_METHOD_QUARTERLY_CASHFLOW_STATEMENT_CFG

SCRAPY_METHOD_YEARLY_CASHFLOW_STATEMENT_NAME = "yearly cashflow statement"
SCRAPY_METHOD_YEARLY_CASHFLOW_STATEMENT_CFG = {# 現金流量表(年)
    "description": u'現金流量表(年)',
    "module_name": "cmoney_scrapy",
    "class_name": "CMoneyScrapy",
    "data_time_unit": DATA_TIME_UNIT_YEAR,
    "can_set_time_range": False,
}
SCRAPY_METHOD_YEARLY_CASHFLOW_STATEMENT_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_YEARLY_CASHFLOW_STATEMENT_NAME] = SCRAPY_METHOD_YEARLY_CASHFLOW_STATEMENT_CFG
...
SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_NAME = "quarterly financial ratio"
SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_CFG = {# 財務比率(季)
    "description": u'財務比率(季)',
    "module_name": "cmoney_scrapy",
    "class_name": "CMoneyScrapy",
    "data_time_unit": DATA_TIME_UNIT_QUARTER,
    "can_set_time_range": False,
}
SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_NAME] = SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_CFG

SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_NAME = "yearly financial ratio"
SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_CFG = {# 財務比率(年)
    "description": u'財務比率(年)',
    "module_name": "cmoney_scrapy",
    "class_name": "CMoneyScrapy",
    "data_time_unit": DATA_TIME_UNIT_YEAR,
    "can_set_time_range": False,
}
SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_NAME] = SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_CFG

# SCRAPY_METHOD_MONTHLY_REVENUE_GROWTH_RATE_NAME = "monthly revenue growth rate"
# SCRAPY_METHOD_MONTHLY_REVENUE_GROWTH_RATE_CFG = {# 月營收成長率
#     "description": u'月營收成長率',
#     "module_name": "statement_dog_scrapy",
#     "class_name": "StatementDogScrapy",
#     "data_time_unit": DATA_TIME_UNIT_MONTH,
#     "can_set_time_range": False,
# }
# SCRAPY_METHOD_MONTHLY_REVENUE_GROWTH_RATE_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
# SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_MONTHLY_REVENUE_GROWTH_RATE_NAME] = SCRAPY_METHOD_MONTHLY_REVENUE_GROWTH_RATE_CFG

# SCRAPY_METHOD_EPS_GROWTH_RATE_NAME = "eps growth rate"
# SCRAPY_METHOD_EPS_GROWTH_RATE_CFG = {# 每股盈餘成長率
#     "description": u'每股盈餘成長率',
#     "module_name": "statement_dog_scrapy",
#     "class_name": "StatementDogScrapy",
#     "data_time_unit": DATA_TIME_UNIT_QUARTER,
#     "can_set_time_range": False,
# }
# SCRAPY_METHOD_EPS_GROWTH_RATE_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
# SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_EPS_GROWTH_RATE_NAME] = SCRAPY_METHOD_EPS_GROWTH_RATE_CFG

# SCRAPY_METHOD_NET_ASSET_VALUE_NAME = "net asset value"
# SCRAPY_METHOD_NET_ASSET_VALUE_CFG = {# 每股淨值
#     "description": u'每股淨值',
#     "module_name": "statement_dog_scrapy",
#     "class_name": "StatementDogScrapy",
#     "data_time_unit": DATA_TIME_UNIT_QUARTER,
#     "can_set_time_range": False,
# }
# SCRAPY_METHOD_NET_ASSET_VALUE_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
# SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_NET_ASSET_VALUE_NAME] = SCRAPY_METHOD_NET_ASSET_VALUE_CFG

SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_GROWTH_RATE_NAME = "quarterly financial ratio growth rate"
SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_GROWTH_RATE_CFG = {# 財務比率成長率(季)
    "description": u'財務比率成長率(季)',
    "module_name": "goodinfo_scrapy",
    "class_name": "GoodInfoScrapy",
    "data_time_unit": DATA_TIME_UNIT_QUARTER,
    "can_set_time_range": False,
}
SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_GROWTH_RATE_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_GROWTH_RATE_NAME] = SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_GROWTH_RATE_CFG

SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_GROWTH_RATE_NAME = "yearly financial ratio growth rate"
SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_GROWTH_RATE_CFG = {# 財務比率成長率(年)
    "description": u'財務比率成長率(年)',
    "module_name": "goodinfo_scrapy",
    "class_name": "GoodInfoScrapy",
    "data_time_unit": DATA_TIME_UNIT_YEAR,
    "can_set_time_range": False,
}
SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_GROWTH_RATE_CFG.update(SCRAPY_METHOD_TYPE_SELENIUM_STOCK)
SCRAPY_METHOD_CONSTANT_CFG[SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_GROWTH_RATE_NAME] = SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_GROWTH_RATE_CFG
...
SCRAPY_METHOD_OPTION_OPEN_INTEREST_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_OPTION_OPEN_INTEREST_NAME)
SCRAPY_METHOD_WEEKLY_OPTION_OPEN_INTEREST_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_WEEKLY_OPTION_OPEN_INTEREST_NAME)
SCRAPY_METHOD_REVENUE_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_REVENUE_NAME)
SCRAPY_METHOD_QUARTERLY_CASHFLOW_STATEMENT_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_QUARTERLY_CASHFLOW_STATEMENT_NAME)
SCRAPY_METHOD_YEARLY_CASHFLOW_STATEMENT_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_YEARLY_CASHFLOW_STATEMENT_NAME)
...
SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_NAME)
SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_NAME)
# SCRAPY_METHOD_MONTHLY_REVENUE_GROWTH_RATE_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_MONTHLY_REVENUE_GROWTH_RATE_NAME)
# SCRAPY_METHOD_EPS_GROWTH_RATE_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_EPS_GROWTH_RATE_NAME)
# SCRAPY_METHOD_NET_ASSET_VALUE_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_NET_ASSET_VALUE_NAME)
SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_GROWTH_RATE_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_QUARTERLY_FINANCIAL_RATIO_GROWTH_RATE_NAME)
SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_GROWTH_RATE_INDEX = SCRAPY_METHOD_NAME.index(SCRAPY_METHOD_YEARLY_FINANCIAL_RATIO_GROWTH_RATE_NAME)
