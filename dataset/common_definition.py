...
DEF_SR_COLOR_HTML_STYLE_CUR = "%s {color: %s; background-color: %s;}" % (COLOR_HTML_TAG_CUR , SR_HTML_TEXT_COLOR_YELLOW, SR_HTML_TEXT_COLOR_BLACK)
...
SR_CONF_FIELD_KEY_SR_INDEX = 1
SR_CONF_FIELD_AUTO_DETECT_JUMP_GAP_INDEX = 2
SR_CONF_FIELD_JUMP_GAP_INDEX = 3
SR_CONF_FIELD_TREND_LINE_INDEX = 4
SR_CONF_FIELD_SHOW_MAIN_KEY_SR_INDEX = 5
SR_CONF_FIELD_OVERWRITE_DATASET_INDEX = 6
SR_CONF_FIELD_DRAW_SR_DATE_INDEX = 7
SR_CONF_FIELD_DRAW_SR_PRICE_INDEX = 8
SR_CONF_FIELD_SAVE_FIGURE_INDEX = 9
SR_CONF_FIELD_GENERATE_REPORT_INDEX = 10
SR_CONF_FIELD_OUTPUT_FOLDER_PATH_INDEX = 11
