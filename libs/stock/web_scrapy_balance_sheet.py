...
# 資產負債表
class WebScrapyBalanceSheet(WebScrapyStatementBase.WebScrapyStatementBase):
    ...
    def show_statement_field_dimension(cls, auto_gen_sql_element=True):
        ...
        cls._show_statement_field_dimension_internal(CMN.DEF.DEF_BALANCE_SHEET_INTEREST_FIELD_METADATA_FILENAME, auto_gen_sql_element)
