...
class ScrapyBase(object):
    ...
    class Web2CSVTimeRangeUpdate(object):
        ...
        WEB2CSV_APPEND_BEFORE = 1 #  new web data will be appended in front of the old csv data
        WEB2CSV_APPEND_AFTER = 2 #  new web data will be appended in back of the old csv data
        # WEB2CSV_APPEND_BOTH = 3 #  new web data will be appended in front and back(both) of the old csv data
        def __init__(self):
        ...
        def backup_old_csv_if_necessary(self, csv_filepath, ignore_old_csv_exist=False):
            ...
            if self.append_direction == self.WEB2CSV_APPEND_BEFORE: #BASE.BASE.ScrapyBase.Web2CSVTimeRangeUpdate.WEB2CSV_APPEND_BEFORE:
...
# The len() function can NOT calculate the length of the None object
    ...
    def __init__(self, **kwargs):
        ...
        self.csv_file_no_scrapy_record = ScrapyBase.CSVFileNoScrapyRecord.create_register_status_instance()
...
# If it's time first time to write the data from web to CSV ......
        web2csv_time_duration_update = ScrapyBase.Web2CSVTimeRangeUpdate()
        ...
        web2csv_time_duration_update.AppendDirection = ScrapyBase.Web2CSVTimeRangeUpdate.WEB2CSV_APPEND_AFTER
...
#                 web2csv_time_duration_update.AppendDirection = ScrapyBase.Web2CSVTimeRangeUpdate.WEB2CSV_APPEND_BACK
...
#                 web2csv_time_duration_update.AppendDirection = ScrapyBase.Web2CSVTimeRangeUpdate.WEB2CSV_APPEND_BEFORE
#             else:
...
#         elif web2csv_time_duration_update.AppendDirection == ScrapyBase.Web2CSVTimeRangeUpdate.WEB2CSV_APPEND_BACK:
# # Check if the new CSV time range is continous
...
# The new time range is extended before the start side of the original time range
            web2csv_time_duration_update_before = ScrapyBase.Web2CSVTimeRangeUpdate()
            ...
            web2csv_time_duration_update_before.AppendDirection = ScrapyBase.Web2CSVTimeRangeUpdate.WEB2CSV_APPEND_BEFORE
...
# The new time range is extended after the end side of the original time range
            web2csv_time_duration_update_after = ScrapyBase.Web2CSVTimeRangeUpdate()
            ...
            web2csv_time_duration_update_after.AppendDirection = ScrapyBase.Web2CSVTimeRangeUpdate.WEB2CSV_APPEND_AFTER
...
# args[0]: web2csv_time_duration_update
    ...
    def CSVFileNoScrapyTypeSize(self):
        return ScrapyBase.CSVFileNoScrapyRecord.RECORD_TYPE_SIZE


    @property
    def CSVFileNoScrapyTypeList(self):
        return ScrapyBase.CSVFileNoScrapyRecord.RECORD_TYPE_LIST


    @property
    def CSVFileNoScrapyTypeDescriptionList(self):
        return ScrapyBase.CSVFileNoScrapyRecord.RECORD_TYPE_DESCRIPTION_LIST


    @property
    def CSVFileNoScrapyTimeRangeNotOverlapRecordIndex(self):
        return ScrapyBase.CSVFileNoScrapyRecord.TIME_RANGE_NOT_OVERLAP_RECORD_INDEX


    @property
    def CSVFileNoScrapyCSVFileAlreadyExistRecordIndex(self):
        return ScrapyBase.CSVFileNoScrapyRecord.CSV_FILE_ALREADY_EXIST_RECORD_INDEX


    @property
    def CSVFileNoScrapyWebDataNotFoundRecordIndex(self):
        return ScrapyBase.CSVFileNoScrapyRecord.WEB_DATA_NOT_FOUND_RECORD_INDEX
