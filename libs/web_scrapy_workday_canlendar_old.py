...
class WebScrapyWorkdayCanlendar(object):
    ...
    def __init__(self, datetime_start=None, datetime_end=None):
        ...
        self.datetime_end = CMN.get_latest_url_data_datetime(CMN.DEF_TODAY_MARKET_DATA_EXIST_HOUR, CMN.DEF_TODAY_MARKET_DATA_EXIST_MINUTE) if datetime_end is None else datetime_end
