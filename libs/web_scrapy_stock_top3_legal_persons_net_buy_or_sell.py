...
class WebSracpyFutureTop3LegalPersonsNetBuyOrSell(web_scrapy_base.WebSracpyBase):
    ...
    def __init__(self, datetime_range_start=None, datetime_range_end=None):
        ...
        super(WebSracpyFutureTop3LegalPersonsNetBuyOrSell, self).__init__(url_format, csv_filename_format, 'utf-8', '.table_f tr', datetime_range_start, datetime_range_end)
