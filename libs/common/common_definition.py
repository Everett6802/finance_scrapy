...
TOP3_LEGAL_PERSONS_STOCK_NET_BUY_OR_SELL_SUMMARY_SCRAPY_CLASS_INDEX = [
...
# Semi-open interval
DATA_SOURCE_MARKET_START = 0
DATA_SOURCE_MARKET_END = SCRAPY_MODULE_FOLDER_MAPPING.index("stock")
DATA_SOURCE_STOCK_START = DATA_SOURCE_MARKET_END
DATA_SOURCE_STOCK_END = len(SCRAPY_MODULE_FOLDER_MAPPING)
DATA_SOURCE_MARKET_SIZE = DATA_SOURCE_MARKET_END - DATA_SOURCE_MARKET_START
DATA_SOURCE_STOCK_SIZE = DATA_SOURCE_STOCK_END - DATA_SOURCE_STOCK_START

DATA_SOURCE_STOCK_STATMENT_START = SCRAPY_MODULE_NAME_MAPPING.index("balance_sheet")
DATA_SOURCE_STOCK_STATMENT_END = SCRAPY_MODULE_NAME_MAPPING.index("statement_of_changes_in_equity") + 1
